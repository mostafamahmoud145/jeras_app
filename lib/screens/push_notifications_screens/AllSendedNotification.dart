...
import '../../screens/push_notifications_screens/sendNotificationScreen.dart';
import '../../widget/generalNotificationItem.dart';

class AllSendedNotificationSreen extends StatefulWidget {
  @override
  _AllSendedNotificationSreenState createState() =>
      _AllSendedNotificationSreenState();
}

class _AllSendedNotificationSreenState extends State<AllSendedNotificationSreen>
            ...
            Expanded(
              child: PaginateFirestore(
                ...
                padding: EdgeInsets.only(
                    left:
                        (kIsWeb || size.width >= AppConstants.kIsWebValue) ? size.width * AppPadding.p0_3 : AppPadding.p16,
                    right:
                        (kIsWeb || size.width >= AppConstants.kIsWebValue) ? size.width * AppPadding.p0_3 : AppPadding.p16,
                ...
                itemBuilder: (context, documentSnapshot, index) {
                  return GeneralNotificationItem(
                    item: GeneralNotifications.fromMap(
