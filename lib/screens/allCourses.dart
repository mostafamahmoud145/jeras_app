...
class AllCourseScreen extends StatefulWidget {
  ...
  const AllCourseScreen({Key? key, this.loggedUser}) : super(key: key);
                        ...
                        child: Center(
                          ...
                          ?25:14.5,
                            ...
                            decoration: InputDecoration(
                              ...
                              suffixIcon: (kIsWeb ||
                                  ...
                                  ? IconButton(
                                      ...
                                      icon: SvgPicture.asset(
                                        AssetsManager.slidersHorizontalIconPath,
                                        width: (kIsWeb ||
                                                size.width >=
                                                    AppConstants.kIsWebValue)
                                            ? AppSize.w26.w
                              ...
                              hintText: getTranslated(context, "courseName"),
                              hintStyle: TextStyle(
                                fontFamily:
                      ...
                      children: [
                        Align(
                          ...
                          child: Padding(
                            ...
                            child: Text(
                              getTranslated(context, "allCours"),
                              style: TextStyle(
                                  fontFamily: getTranslated(context, "Ithra"),
